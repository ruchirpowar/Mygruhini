...
<html>
	...
	<body>
        <header>
            <div class="head-img">
                <a href="ppl.php"><h1>My Gruhini</h1></a>
            </div>
            <!-- NAVBAR -->
            <nav id="navbar">
                ...
                <ul class="menu">
                    ...
                    <div class="icons">
                        <li class="user"><a href="ppl.php?page=login" ></a></li>
                        <li class="user" id="shopping-cart"><a href="ppl.php?page=cart"><i class="fas fa-shopping-cart"></i><span>$num_items_in_cart</span></a></li>
...
echo <<<EOT
        ...
        <footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-company-name">&copy; $year, My Gruhini Pvt. Ltd.</p>
			</div>
