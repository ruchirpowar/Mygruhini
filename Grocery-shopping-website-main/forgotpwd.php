    ...
    <div id="main-content" class="container">
        <div class="box2"> <!--forms-container -->
            <div class="login-wrapper">
                <h2 class="title">My<span> Gruhini</span></h2>
                                ...
                                <div class='content'>
                                    ...
                                    <tr>
                                        ...
                                        <table border='0' cellpadding='0' cellspacing='0'>
                                            ...
                                            <td>
                                                <p>Hi,</p>
                                                <p>We have received a password reset request from the email address $email on My Gruhini.</p>
                                    ...
                                    <table border='0' cellpadding='0' cellspacing='0'>
                                        ...
                                        <td class='content-block'>
                                            <span class='apple-link'>My Gruhini, 27 XYZ Road, Mulund, Maharashtra,India 445001</span>
                                            <br> This is mandatory service email sent to you by My Gruhini pvt Ltd.
                                        </td>
                                        </tr>
                                        <tr>
                                        <td class='content-block powered-by'>
                                            Powered by <a href='http://localhost/store/index.php'>My Gruhini</a>.
                                        </td>
                                        </tr>
                                    </table>
                                    </div>
