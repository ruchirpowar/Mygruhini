...
<body>
    <header>
    <div class="parallax">
        <div class="page-title">My Gruhini</div>
    </div>
    <nav id="navbar">
        ...
        <form action="index.php?page=search" method="post">
            ...
            <div class="icons">
                ...
                <li class="user" id="shopping-cart"><a href="index.php?page=cart"><i class="fas fa-shopping-cart"></i><span><?=$num_items_in_cart?></span></a></a></li>
    ...
    <div class="container">
        <div class="row">
           ...
           <!-- Slideshow container -->
            ...
            <div class="mySlides fade">
            <div class="numbertext"></div>
            <img src="img/r2.jpg" style="width:100%" height="500px" >
        ...
        <div class="about-us"><h1 style="text-align: center;">About Us</h1>
            <p>Did you ever imagine that the freshest of fruits and vegetables, top quality pulses and food grains, dairy products and hundreds of branded items could be handpicked and delivered to your home, all at the click of a button? </p>
                <p>India’s first comprehensive online megastore, mygruhini.com, brings a whopping 20000+ products with more than 1000 brands, to over 4 million happy customers. From all the vegies to dairy products, mygruhini has everything you need for your daily needs.</p>
                <p> mygruhini.com is convenience personified We’ve taken away all the stress associated with shopping for daily essentials, and you can now order all your groceries online without travelling long distances or standing in serpentine queues. Add to this the convenience of finding all your requirements at one single source, along with great savings, and you will realize that mygruhini- India’s largest online supermarket, has revolutionized the way India shops for groceries.</p>
    ...
    <footer class="footer-distributed">
        ...
        <div class="footer-left">
            ...
            <p class="footer-company-name">© 2022 My Gruhini Pvt. Ltd.</p>
         </div>
        ...
        <div class="footer-center">
            ...
            <div>
                ...
                <p><a href="mailto:bigapplegrocerystore@gmail.com">mygruhini@gmail.com</a></p>
            </div>
        </div>
        <div class="footer-right">
            <p class="footer-company-about">
                    <span>About the company</span>
                    mygruhini.com allows you to walk away from the drudgery of grocery shopping and welcome an easy relaxed way of browsing and shopping for groceries.
            </p>
