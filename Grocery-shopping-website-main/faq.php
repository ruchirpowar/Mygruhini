<html>
    ...
    <header>
        ...
        <?php if(isset($_SESSION['sess_user_id']) && $_SESSION['sess_user_id'] != ""):?>
            <ul class="topnav-right">
                ...
                <li>
                    <a href="ppl.php?page=logout">Log out</a>
                </li>
            </ul>
        <?php else:?>
            <ul class="topnav-right">
    ...
    <div class="box">
        ...
        <details>
            ...
            <p class="text">You can pay for your order on googlepay.com using the following modes of payment:a. Cash on delivery (COD)b. Credit and debit cards (VISA / Mastercard / Rupay)c.
